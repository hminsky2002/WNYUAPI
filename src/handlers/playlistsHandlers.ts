...
const getPlaylists = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
const getPlaylistById = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
