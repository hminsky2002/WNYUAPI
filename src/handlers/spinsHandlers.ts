...
const getSpins = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
const getSpinById = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
