...
const getShows = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
const getShowById = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
